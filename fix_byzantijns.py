...
IMG_DIR = Path('/root/.openclaw/workspace/kunstgeschiedenis/website/images/byzantijns')
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'}

# Missing Byzantijns images
images = [
    ...
    ("David Plates Byzantine", "07_davidplates.jpg"),
...
print("📥 Downloading Byzantijns images...")
