#!/usr/bin/env python3
"""
Part 1: Add missing perspectives to tijdsgeest.json
This script adds philosophical_perspective and psychological_perspective to Abstract Expressionisme
"""
...
# Define the content for Abstract Expressionisme
abstract_expressionisme_updates = {
...
# Find Abstract Expressionisme in the movements list and update it
for i, movement in enumerate(data['art_movements']):
    if movement['name'] == 'Abstract Expressionisme':
        print(f"Found Abstract Expressionisme at index {i}")
        data['art_movements'][i]['philosophical_perspective'] = abstract_expressionisme_updates['philosophical_perspective']
        data['art_movements'][i]['psychological_perspective'] = abstract_expressionisme_updates['psychological_perspective']
...
print("\n✓ Successfully updated Abstract Expressionisme")
print("  philosophical_perspective: added")
print("  psychological_perspective: added")
